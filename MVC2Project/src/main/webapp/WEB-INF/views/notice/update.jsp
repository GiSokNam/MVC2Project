...
<head>
<meta charset="UTF-8">
<title>project/notice/update.jsp</title>
...
<!-- 왼쪽메뉴 -->
<!-- 본문내용 -->
 <form action="${pageContext.request.contextPath}/notice/updatePro" id="board" method="post">
 ...
 <h1>Notice Update</h1>
  <table>
   <tr>
    ...
    <tr>
     <th>내용</th>
     <td><textarea rows="30" cols="50" name="content">${noticeDTO.content}</textarea></td>
    </tr>
    <tr>
     <td colspan="2">
      <div id="table_btn">
